...
Affective commitment is one of the three components of organizational commitment, representing the "emotional" link between an employee and the firm. It generally requires an individual to be integrated into interpersonal relationships to maintain and develop them (source: Gao and Gao - 2024.md, p. 6).

## Relationship with Other Variables

### In the CAPS Framework
Under the [[cognitive-affective-processing-system]] framework, affective commitment represents the affective path through which external situational features influence behavior:
...
- **Scale**: 6-item scale (Allen and Meyer, 1990), measured on a 5-point Likert scale (1 = strongly disagree to 5 = strongly agree).
- **Reliability**: High internal consistency (Cronbach's α = 0.925, AVE = 0.713, CR = 0.925) (source: Gao and Gao - 2024.md, p. 12).
