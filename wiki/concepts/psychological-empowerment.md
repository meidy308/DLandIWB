...
tags: [concept, variable, cognition]
...
Psychological empowerment represents an individual's psychological state or orientation toward their work role. It is viewed as an internal motivation mechanism that translates external situational factors (like leadership) into proactive behavioral outcomes such as innovation (source: Gao and Gao - 2024.md, p. 5).

## Dimensions

Psychological empowerment consists of four key cognitions (source: Gao and Gao - 2024.md, p. 5):

1. **Meaning**: The value of an individual's work goals, judged in relation to their own ideals or standards.
2. **Competence**: An individual's belief in their capability to perform work activities with skill (self-efficacy).
3. **Self-determination**: A sense of having choice and autonomy in initiating and regulating work actions.
...
- **Scale**: 12-item scale (Spreitzer, 1995), measured on a 5-point Likert scale (1 = strongly disagree to 5 = strongly agree).
- **Reliability**: Excellent internal consistency (Cronbach's α = 0.963, AVE = 0.686, CR = 0.963) (source: Gao and Gao - 2024.md, p. 12).
