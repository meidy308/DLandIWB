...
The Job Demands-Resources (JD-R) model was foundationally introduced by Demerouti et al. (2001) and later expanded into a "state of the art" framework by Bakker and Demerouti (2007). The core premise is that every occupation has its own specific risk factors, but these can always be classified into two broad categories: [[job-demands]] and [[job-resources]].
...
Later iterations of the model acknowledge that the relationship is not unidirectional:
- **Reciprocal causal effects**: Well-being can also predict future demands and resources. High engagement can lead to a "gain spiral" where employees mobilize more resources, while burnout can lead to a "loss spiral" (source: Bakker and Demerouti - 2007.md, p. 321).
- **Job Crafting**: Employees act as active agents who shape, mold, and redefine their jobs to maintain a balance between their resources and demands (source: Bakker and Demerouti - 2007.md, p. 322).
...
Zia et al. (2024) specifically apply JD-R to the digital domain, conceptualizing [[digital-communication]] and [[digital-training]] as job resources that help employees cope with digital demands and achieve goals through increased [[digital-engagement]] (source: Zia et al. - 2024.md, p. 5).
