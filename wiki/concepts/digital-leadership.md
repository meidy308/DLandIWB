...
Digital leadership is measured through varying dimensional frameworks across the studies:

**Afif and Fitrianingrum (2025)** — 3 indicators (source: Afif and Fitrianingrum - 2025.md, p. 3113):
1. **Technology integration** — Allocating technology into work processes (mean = 4.27).
2. **Adaptability** — High ability to adapt to changes and problems (mean = 4.40).
3. **Innovation** — Motivating subordinates to produce innovations (mean = 4.33).

**Deviren (2026)** — 2 subdimensions (source: Deviren - 2026.md, p. 36):
1. **Innovative leadership** — Driving innovation within digital contexts.
2. **Supportive leadership** — Providing support and creating environments conducive to digital transformation.
...
3. **Up-to-date knowledge** — Leader stays current with digital trends.
4. **Proactive drive** — Proactively driving digital transformation in the unit.
5. **Enthusiasm** — Ability to make others enthusiastic about transformation.
6. **Structural clarity** — Clear idea of the structures and processes required for transformation.

**Wang et al. (2025)** — 5 dimensions (Wang et al., 2022; Zhu, 2015) (source: Wang et al. - 2025.md, p. 6):
1. **Creativity**
2. **Thinking and inquisition**
3. **Curiosity**
4. **Deep knowledge**
...
Digital leadership has a positive and significant effect on [[innovative-work-behavior]] across all studies, though the effect size varies considerably:
...
- **Afif and Fitrianingrum (2025)**: 3 indicators, 5-point Likert. Reliability: Cronbach's α = 0.786, CR = 0.875, AVE = 0.700 (source: Afif and Fitrianingrum - 2025.md, p. 3116–3117).
...
- **Rahmandika et al. (2025)**: 6 items (adapted from Zhu, 2022), 5-point Likert. Reliability: Cronbach's α = 0.817, CR = 0.900, AVE = 0.647 (source: Rahmandika et al. - 2025.md, p. 245, 248–249).
- **Soediro et al. (2025)**: Validated scales adapted from previous studies (mentions Ehlers, 2020), 5-point Likert. Reliability: Cronbach's α = 0.834, CR = 0.883, AVE = 0.601 (source: Soediro et al. - 2025.md, p. 237, 268-300).
- **Wang et al. (2025)**: 17-item scale (Zhu, 2015), 5-point Likert. Reliability: Cronbach's α = 0.946, AVE = 0.538, CR = 0.952 (source: Wang et al. - 2025.md, p. 6-7).

## IPMA Priority Insights

Importance-Performance Map Analysis (IPMA) in the retail sector indicates that digital leadership exhibits the lowest relative effect coefficient compared to digital literacy and innovative work behavior, yet it is identified as the **primary strategic priority** for enhancement to boost salesperson performance (source: Hang and Nguyệt - 2026.md, p. 15).
