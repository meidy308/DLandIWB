---
title: "Farhaq & Yulianti (2024) – Pengaruh Digital Leadership Terhadap Kinerja Karyawan Dimediasi oleh Perilaku Kerja Inovatif Karyawan Milenial"
tags: [source, public-sector, quantitative]
date-created: 2026-04-17
date-updated: 2026-04-17
confidence: high
---

# Farhaq & Yulianti (2024) – Pengaruh Digital Leadership Terhadap Kinerja Karyawan Dimediasi oleh Perilaku Kerja Inovatif Karyawan Milenial
...
- **Author**: Nur Candra Farhaq & Emma Yulianti (Universitas Hayam Wuruk Perbanas)
- **Year**: 2024
- **Journal**: Public Policy: Jurnal Aplikasi Kebijakan Publik dan Bisnis, 5(1), 394–410
- **Methodology**: Quantitative
- **Sample**: 139 millennial employees, East Java, Indonesia
- **Analysis**: Partial Least Squares (PLS) using Smart-PLS 4
- **Data collection**: Online questionnaire via Google Form (convenience sampling)

## Research Model

- **Independent variable**: [[digital-leadership]] (Combo of digital culture and competence to optimize resources)
- **Dependent variable**: [[employee-performance]] (Work results achieved according to standards/regulations)
- **Mediator**: [[innovative-work-behavior]] (Generating, directing, and implementing new ideas)

## Hypotheses and Results

| Hypothesis | Description | Result |
|---|---|---|
| H1 | [[digital-leadership]] → [[employee-performance]] (+) | **Supported** (T = 2.581, p = 0.010) |
| H2 | [[digital-leadership]] → [[innovative-work-behavior]] (+) | **Supported** (T = 25.500, p = 0.000) |
| H3 | [[innovative-work-behavior]] → [[employee-performance]] (+) | **Supported** (T = 5.315, p = 0.000) |
| H4 | [[digital-leadership]] → [[innovative-work-behavior]] → [[employee-performance]] | **Supported** (T = 5.023, p = 0.000) |
